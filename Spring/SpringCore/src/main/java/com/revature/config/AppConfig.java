...
@Configuration
/*
 * The @ComponentScan annotation tells Spring which packages to scan for Spring stereotypes.
 */
@ComponentScan(basePackages = {"com.revature.service", "com.revature.repository"})
public class AppConfig {
	
	/*
	 * If you wish to tell Spring to add beans to the container, you should declare methods which
	 * return those beans and annotate those methods with @Bean.
	 * 
	 * Note that I've commented these methods out because we simply don't need them as we are switching
	 * Spring stereotypes.
	 */
