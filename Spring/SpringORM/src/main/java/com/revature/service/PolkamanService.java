...
//	}
	...
	public List<Polkaman> sortPolkamansByName(){
		
		/*
		 * I can't sort Polkamans I don't have, so I need to call the findAll method
		 * from the PolkamanRepositoryImpl.
		 */
		 ...
		 * list.
		 */
		Collections.sort(polkamans, (polkaman1, polkaman2) -> 
			{return polkaman1.getPolka_name().compareTo(polkaman2.getPolka_name());});
